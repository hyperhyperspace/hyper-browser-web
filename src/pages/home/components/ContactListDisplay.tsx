...
export default (props: {contact: Contact, selfHash?: Hash }) => {
const { contact } = props;
return <>
    <ListItemIcon>
    ...
    <ListItemText
        primary={<Stack direction="row" spacing={1}><Typography>{contact.name}</Typography>{contact.hash === props.selfHash && <Chip size="small" label='You' />}</Stack>}
